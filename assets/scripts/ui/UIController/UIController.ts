...
const FULLSCREEN_ERROR_TITLE = 'Full Screen Error'
const MOBILE_NATIVE_NO_WINDOWED_MESSAGE = 'Full screen mode must remain enabled on mobile device.'
...
const HARDWARE_ACCELERATION_LOCKED_MESSAGE = '3D acceleration must remain enabled in this version.'
