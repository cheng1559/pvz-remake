export const CRAZY_DAVE_ANIMATION_PATH = 'animations/crazydave'
export const CRAZY_DAVE_X = 0
export const CRAZY_DAVE_Y = 0
export const CRAZY_DAVE_INTRO_DELAY_SECONDS = 2
export const CRAZY_DAVE_FIRST_DIALOG_START = 2400
